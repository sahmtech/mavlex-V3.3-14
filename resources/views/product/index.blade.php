...
<div class="main-container no-print">
    ...
    <div class="card-wrapper">
        ...
        <div class="overview-filter">
            ...
            <div class="filter">
                <a href="{{ action('LabelsController@show') }}" style="color:#333;"> <img src="{{ asset('/img/icons/export.svg') }}" alt="" >@lang('barcode.print_labels')</a>
                <!-- Export Button -->
                <div class="new-user">
                    @can('product.create')
        ...
        <div class="col-sm-3">
            <div class="form-group">
                <p><strong>@lang('lang_v1.not_for_selling')</strong></p>
                <div class="toggle-wrapper d-flex gap-2 mt-4">
                    <label class="switch" for="not_for_selling">
                        {!! Form::checkbox('not_for_selling', 1, false, ['id' => 'not_for_selling']) !!}
        ...
        @if($is_woocommerce)
            <div class="col-sm-3">
                <div class="form-group">
                    <p>@lang('lang_v1.woocommerce_enabled')</p>
                    <div class="toggle-wrapper d-flex gap-2 mt-4">
                        <label class="switch" for="woocommerce_enabled">
                            {!! Form::checkbox('woocommerce_enabled', 1, false, ['id' => 'woocommerce_enabled']) !!}
                            <div class="sliderCheckbox round"></div>
                        </label>
                    </div>
                </div>
      ...
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <h4 class="modal-title" style="display: block; text-align: center;" id="myModalLabel">Product Link</h4>
          </div>
          <div class="modal-body" style="text-align: center;">
            <div class="form-group">
              {!! Form::text('link', null, ['id'=>'product-link-cont', 'class'=>'form-control',
                'placeholder' => __('Product Link')]); !!}
            </div>
          </div>
          <div class="modal-footer">
            <a class="btn productcopybtn" href="#"  id="modal-copybtn">
                <img src="{{ asset('img/icons/copy.svg') }}" alt="plus"> Copy Link
            </a>
...
@section('javascript')
    <script src="{{ asset('js/product.js?tok='.rand(0,999)) }}"></script>
    <script src="{{ asset('js/opening_stock.js?v=' . $asset_v) }}"></script>
    <script type="text/javascript">
        // Copy onclick function for Product Link
        function copyProductLink(e){
            $('#product-link-cont').val($(e).attr('data-href'));
            $('#modal-1').modal('toggle');
        }
        
        var copyTextareaBtn = document.querySelector('.productcopybtn');
        copyTextareaBtn.addEventListener('click', function(event) {
          var copyTextarea = document.querySelector('#product-link-cont');
          copyTextarea.select();
          try {
        ...
        $(document).ready( function(){
            product_table = $('#product_table').DataTable({
                ...
                columns: [
                        ...
                        { data: 'image', name: 'products.image', @if(!session('business.enable_product_image')) visible: false @endif  },
                        ...
                        { data: 'brand', name: 'brands.name', @if(!session('business.enable_brand')) visible: false @endif}
  ...
  product_table.ajax.reload();
    ...
    $(document).on('shown.bs.modal', '.product_filter_modal', function(){
