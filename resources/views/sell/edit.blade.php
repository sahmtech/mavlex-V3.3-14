...
<div class="main-container no-print">
	...
	<div class="card-wrapper">
		<div class="overview-filter">
			<div class="title">
				<h1>{{$title}}</h1>
				<p> <small>(@if($transaction->type == 'sales_order') @lang('restaurant.order_no') @else @lang('sale.invoice_no') @endif: <span class="text-success">#{{$transaction->invoice_no}})</span></small></p>
			</div>
		</div>
		<br />
						...
						<div class="row">
							...
							<div class="col-sm-3 pull-right ">
								<div class="checkbox">
									...
									</label><button type="button" data-toggle="modal" data-target="#recurringInvoiceModal" class="btn btn-link"><i class="fa fa-external-link-alt"></i></button>@show_tooltip(__('lang_v1.recurring_invoice_help'))
								</div>
							</div>
							@endif
	...
	<div class="invoice-footer">
			...
			<button type="button" class="save-btn" id="submit-sell">@lang('messages.update')</button>
			<button type="button" id="save-and-print" class="save-record-payment">@lang('lang_v1.update_and_print')</button>
		</div>
	</div>
	@if(in_array('subscription', $enabled_modules))
