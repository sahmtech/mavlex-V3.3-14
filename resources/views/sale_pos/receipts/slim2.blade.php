...
<body>
	<div class="receipt">
		<div class="ticket">
			...
			<br /><span class="sub-headings">{!! $receipt_details->prebill_text !!}</span>
			...
			<br /><span class="sub-headings">{!! $receipt_details->order_type !!}</span>
			@endif
			@if(!empty($receipt_details->letter_head))
					<div class="text-box">
			...
			<div class="qr-code-container center-block">
