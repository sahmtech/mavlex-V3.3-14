...
<div class="row">
	...
	<div class="@if(!empty($receipt_details->footer_text)) col-xs-4 @else col-xs-12 @endif text-center">
		...
		@endif
		@if (isset($receipt_details->is_connected) && $receipt_details->is_connected && $receipt_details->show_qr_code && !empty($receipt_details->qr_code_text))
		<div class="qr-code-container center-block mt5">
...
@if(!empty($receipt_details->exchange_rate) && $receipt_details->exchange_rate > 0)
@if(!empty($receipt_details->foreign_currency_label) || !empty($receipt_details->foreign_currency))
@if(!empty($receipt_details->foreign_currency_label))
<b>{!! $receipt_details->foreign_currency_label !!}:</b>
{{$receipt_details->foreign_currency}}<br>
@endif

@endif

@if(!empty($receipt_details->exchange_rate_label) || !empty($receipt_details->exchange_rate))
@if(!empty($receipt_details->exchange_rate_label))
<b>{!! $receipt_details->exchange_rate_label !!}:</b>
{{$receipt_details->exchange_rate}}<br>
@endif

@endif

@if(!empty($receipt_details->paid_foreign_currency_label) || !empty($receipt_details->paid_foreign_currency))
@if(!empty($receipt_details->paid_foreign_currency_label))
<b>{!! $receipt_details->paid_foreign_currency_label !!}:</b>
{{$receipt_details->foreign_currency_symbol}} {{$receipt_details->paid_foreign_currency}}<br>
@endif


@endif

@if(!empty($receipt_details->return_local_currency_label) || !empty($receipt_details->return_local_currency))
@if(!empty($receipt_details->return_local_currency_label))
<b>{!! $receipt_details->return_local_currency_label !!}:</b>
{{$receipt_details->return_local_currency}}<br>
@endif
