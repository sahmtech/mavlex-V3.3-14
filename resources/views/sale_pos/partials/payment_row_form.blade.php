<div class="row">
	...
	<div class="{{$col_class}}">
		<div class="form-group">
			...
			<div class="sale_amount_target_label" style="display: none;" >
			{!! Form::label("amount_$row_index" , __('sale.amount') . ':*') !!} <span class="target-currency-label"></span>
		</div>
			<input type="text" class="form-control target-amount" id="target_amount_{{ $row_index }}" placeholder="Target Amount" style="margin-top: 5px; display: none;" value="">
