        ...
        if (request()->ajax()) {
            ...
            return Datatables::of($tax_rates)
                ->addColumn(
                    ...
                    @endcan
                    @can("tax_rate.delete")
                        <button title="@lang("messages.delete")" data-toggle="tooltip" data-placement="top" data-href="{{action(\'TaxRateController@destroy\', [$id])}}" class="delete_tax_rate_button" style="display: inline-block;">
