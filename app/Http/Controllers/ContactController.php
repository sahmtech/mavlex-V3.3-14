...
class ContactController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('contact.create')
            ->with(compact('types', 'customer_groups', 'selected_type', 'module_form_parts', 'users', 'is_zatca'));
    }
    ...
    public function edit($id)
    {
        ...
        if (request()->ajax()) {
            ...
            return view('contact.edit')
                ->with(compact('contact', 'types', 'customer_groups', 'opening_balance', 'users', 'is_zatca'));
        }
    }
    ...
    public function filter()
    {
        ...
        return view('contact.partials.filter')
            ->with(compact('customer_groups', 'reward_enabled', 'type'));
    }
}
