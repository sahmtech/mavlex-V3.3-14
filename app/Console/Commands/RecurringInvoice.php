                ...
                try {
                    ...
                    if (! empty($last_generated)) {
                        ...
                        if ($transaction->recur_interval_type == 'days') {
                            $diff_from_today = $last_generated->diffInDays($today , true);
                            ...
                            $diff_from_today = $last_generated->diffInMonths($today , true);
                        } elseif ($transaction->recur_interval_type == 'years') {
                            $diff_from_today = $last_generated->diffInYears($today , true);
                        }
