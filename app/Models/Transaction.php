...
class Transaction extends Model
{
     ...
     * @var array
     */
    protected $guarded = ['id', 'trans_date'];
    ...
    {
        $path = !empty($this->document) ? upload_asset('uploads/documents/' . $this->document) : null;
    ...
    {
        return $this->belongsTo(\App\Models\User::class, 'delivery_person');
    }
    ...
    {
        return $this->hasMany(\App\Models\InvoiceNote::class, 'transaction_id');
    }

    public function reminders()
    {
        return $this->hasMany(\App\Models\InvoiceReminder::class, 'transaction_id');
    }
    /**
