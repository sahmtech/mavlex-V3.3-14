...
function __calculate_amount(
  // calculation_type, calculation_amount, amount
  calculation_type,
  calculation_amount,
  amount,
  min_amount = 0,
  ...
  calculation_amount_2 = isNaN(calculation_amount_2) ? 0 : calculation_amount_2;
  ...
  switch (calculation_type) {
    case "fixed":
      if (calculation_amount_2 > 0) {
        return (
          parseFloat(calculation_amount) + parseFloat(calculation_amount_2)
        );
      } else {
      ...
      if (calculation_amount_2 > 0) {
        ...
        if (calculation_amount > calculation_amount_2) {
          ...
          if (min_amount_2 > 0 && res < min_amount_2) {
            ...
            var div = Decimal.div(calculation_amount_2, 100).toNumber();
