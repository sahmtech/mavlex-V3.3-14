...
return [
    ...
    'customer_groups_report' => 'Customer Groups',
    'none' => 'None',
    ...
    'product_purchase_report' => 'Product Purchase',
    'unit_perchase_price' => 'Unit Purchase Price',
    'search_product' => 'Search Product',
    'product_sell_report' => 'Product Sales',
    ...
    'sell_payment_report' => 'Sell Payment',
    ...
    'save_n_add_selling_price_group_prices' => 'Save & Add Group Prices',
    ...
    "ep_unit_cost_before_discount" => 'Enable unit cost before discount column',
    'ep_unit_cost_before_discount_tooltip' => 'If enabled unit cost before discount column will be shown in print purchase',
    'ep_unit_cost_price_before_tax' => 'Enable unit cost price before tax column',
    'ep_unit_cost_price_before_tax_tooltip' => 'If enabled unit cost before tax column will be shown in print purchase',
    'ep_sub_total_before_tax' => 'Enable sub total before tax column',
    'ep_sub_total_before_tax_tooltip' => 'If enabled sub total before tax column will be shown in print purchase',
    'ep_unit_cost_price_after_tax' => 'Enable unit cost price after tax column',
    'ep_unit_cost_price_after_tax_tooltip' => 'If enabled unit cost after tax column will be shown in print purchase',
    'ep_unit_selling_price' => 'Enable unit selling price column',
    'ep_unit_selling_price_tooltip' => 'If enabled selling price column will be shown in print purchase',
    'ep_sub_total' => 'Enable sub total column',
    'ep_sub_total_tooltip' => 'If enabled sub total column will be shown in print purchase',
    'ep_payment_info' => 'Enable payment info',
    'ep_payment_info_tooltip' => 'If enabled payment info details will be shown in print purchase',
    'ep_net_total_amount' => 'Enable net total amount column',
    'ep_net_total_amount_tooltip' => 'If enabled net total amount column will be shown in print purchase',
    'ep_discount' => 'Enable discount column',
    'ep_discount_tooltip' => 'If enabled discount column will be shown in print purchase',
    'ep_purchase_tax' => 'Enable purchase tax column',
    'ep_purchase_tax_tooltip' => 'If enabled purchase tax column will be shown in print purchase',
    'ep_additional_shipping_charges' => 'Enable additional shipping charges column',
    'ep_additional_shipping_charges_tooltip' => 'If enabled additional shipping charges column will be shown in print purchase',
    'ep_purchase_total' => 'Enable purchase total column',
    'ep_purchase_total_tooltip' => 'If enabled purchase total column will be shown in print purchase',
    'ep_shipping_details' => 'Enable shipping details',
    'ep_shipping_details_tooltip' => 'If enabled shipping details will be shown in print purchase',
    'es_unit_price' => 'Enable unit price column',
    'ep_net_total_amount_tooltip' => 'If enabled unit prise column will be shown in print stock transfer',
    'es_sub_total' => 'Enable subtotal column',
    'es_sub_total_tooltip' => 'If enabled subtotal column will be shown in print stock transfer',
    'es_net_total_amount' => 'Enable net total amount column',
    'es_net_total_amount_tooltip' => 'If enabled net total amount column will be shown in print stock transfer',
    'es_additional_shipping_charges' => 'Enable additional shipping charges column',
    'es_additional_shipping_charges_tooltip' => 'If enabled additional shipping charges column will be shown in print stock transfer',
    'es_purchase_total' => 'Enable purchase total column',
    'es_purchase_total_tooltip' => 'If enabled purchase total column will be shown in print stock transfer',
    'es_approved_by' => 'Enable approved by',
    'es_approved_by_tooltip' => 'If enabled approved by will be shown in print stock transfer',
    'approved_by' => 'Approved by',
    'drafts' => 'Drafts',
    'quotations' => 'Quotations',
    'stock_manager' => 'Stock Manager',
    'ep_reference' => 'Enable reference field',
    'ep_pay_term' => 'Enable pay term',
    'ep_additional_expenses' => 'Enable additional expenses',
    'ep_reference_tooltip' => 'If enabled reference field will be shown in add purchase',
    'ep_pay_term_tooltip' => 'If enabled pay term field will be shown in add purchase',
    'ep_additional_expenses_tooltip' => 'If enabled additional expenses column will be shown in add purchase',
    ...
    "premium_modules" => "Premium Modules",
    'debitors_list' => 'Debtor’s List',
    //V1.5
    'hrm_essentials' => 'HRM & Essentials',
    'disable_exchangerate' => 'Disable Exchange Rate',
    ...
    'show_base_unit_details' => 'Show Base Unit Details',
    ...
    'show_racks' => 'Show Racks',
    'taxable' => 'Taxable',
    'pricing' => 'Pricing',
    'product_information' => 'Product Information',
    'product_description' => 'Product Image & Description',
    'sr_no_racks' => 'Product Serial Number, Racks',
    'disable_performance' => 'Disable Performance Widget',
    'disable_sales_due' => 'Disable Sales Due Widget',
    'disable_purchase_due' => 'Disable Purchase Due Widget',
    'disable_stock_alert' => 'Disable Stock Alert Widget',
    'disable_stock_expiry' => 'Disable Stock Expiry Widget',
    'disable_sales_order' => 'Disable Sales Order Widget',
    'disable_purchase_order' => 'Disable Purchase Order Widget',
    'disable_pending_shipments' => 'Disable Pending Shipments Widget',
    'disable_payment_recover' => 'Disable Payment Recovery Widget',
    ...
    'show_product_qty' => 'Show Product Quantity',
    'show_product_qty_tooltip' => 'Show Product Quantity on POS Product Suggestions <br> <strong>Red Label</strong> = Quantity is Zero or less than 0 <br> <strong>Yellow Label</strong> = Stock Management is disabled on Product <br> <strong>Green Label </strong>= Quantity is greater than Zero ',
    'stock_management_disabled' => 'Stock Management Disabled',
    'available_quantity' => 'Stock Available',
    'product_image' => 'Product Image',
    'price_checker' => 'Product Price Check',
    'scan_to_check_price' =>  'Scan to check product price',
    'show_price_check' => 'Show Price Check Screen',
    'show_price_check_tooltip' => 'Price check Screen can be used by customers to check prices before purchase',
    'show_customer_display' => 'Show Customer Display',
    'show_customer_display_tooltip' => 'Dual Screen for customer',
    'customer_display' => 'Customer Display',
    'customer_display_caption' => 'Thank you for Shopping with Us!',
    'no_items' => 'Cart is empty',

    //V2.0
    'manage_calander' => 'Manage Calender',
    'disable_currency_exchange' => ' Disable Currency Exchange',
    'disable_currency_exchange_tooltip' => ' Disable Currency Exchange Rate Module from POS Screen',

    //2.1
    'restaurant_settings' => 'Restaurant Settings',
    'enable_restaurant_module' => 'Enable Restaurant Module',
    'enable_restaurant_module_tooltip' => 'You must enable the Restaurant Module in order to use KOT, Running Orders and Order Type',
    'enable_kot' => 'Enable KOT',
    'enable_kot_tooltip' => 'Enable KOT Button on POS Screen it will print the KOT and send order to Running orders',
    'enable_running_orders' => 'Enable Running Orders',
    'enable_running_orders_tooltip' => 'Running Order are sent after KOT is Printed you can edit/Modify any Running Order',
    'enable_order_type' => 'Enable Order Type',
    'enable_order_type_tooltip' => 'There are three order types by default can be selected from POS Screen <br> Dine-In, Delivery and Takeaway',
    ...
    'view_running_orders' => 'View Running Orders',
    ...
    'order_type_required_tooltip' => 'Enable this option to require selecting an Order Type when making a sale on the POS screen',
    'default_order_type_tooltip' => 'Select your Prefered Default Order type on POS Screen',
    ...
    //2.5.4
    'enable_preparation_time_in_minutes'  => 'Enable Preparation Time in Minutes',
    ...
    'filter' => 'Filter',
    'auto_message_settings' => 'Auto Message Settings',
    'copyright_text' => 'Copyright &copy; :year All rights reserved.',
    'update_app' => 'Update App',
    'send_to_mail' => 'Send to mail',
    'adjust_current_stock' => 'Adjust Current Stock',
    'overall' => 'Overall',
    'overall_tax_formula' => '(Sell - Sell Return) - (Purchase - Purchase Return)',

    'create_account_heading' => 'Create Your :app_name Account.',
    'already_have_an_account' => 'Already Have An Account?',
    'welcome_back' => 'Welcome back.',
    'verified' => 'Verified',
    'email_verified_text' => 'You email has been verified successfully. Thank you for choosing',
    'home' => 'Home',
    'email_verification' => 'Email Verification',
    '404_page' => 'we’re sorry. the page you requested could not be found Please go back to the home page',
    'email_sent_text' => 'We have sent you a verification email to your email address. Click and follow the link inside it',
    'email_not_recieved' => "Didn't recieve mail?",
    'resend' => 'Resend',
    ...
    'value' => 'Value',
    'order_id' => 'Order ID',
    'modifiers_not_available_product' => 'No modifiers available for this product.',
    'issued_on' => 'Issued On',
    'in_words' => 'In Words',
    'get_paid_faster_invoice_text' => 'Get Paid Faster & Keep Track of Invoices',
    'invoice_help_text' => ' With Invoicing , Send invoices to customers via email or download a professional PDF version to share or print',
    'also_send_an_email_reminder' => 'Also Send an Email Reminder',
    'remind' => 'Remind',
    'notified' => 'Notified',
    'total_manufactured' => 'Total Manufactured',
    'total_used_for_production' => 'Total Used For Production',
    ...
    'money_in' => 'Money In',
    'money_out' => 'Money Out',
    'transferred_stock' => 'Transferred Stock',
    'send_mail' => 'Send Mail',
    'view_as_customer' => 'View as Customer',
    'set_reminder' => 'Set Reminder',
    'amount_due' => 'Amount Due',
    'already_paid_click_to_record_payment' => 'Already paid? Click to record Payment?',
    'also_attach_pdf_in_mail' => 'Also attach PDF in mail',
    'preview_invoice_link' => 'Preview Invoice Link',
    'invoice_email_body' => '<p>Dear {contact_name},</p> <p>Good day! We’re excited to let you know that your invoice from {business_name} is ready for you.</p> <p>To view your invoice, click here: {invoice_link}.</p> <p>Thanks for choosing {business_name}. We appreciate your trust and look forward to serving you again soon.</p> <p>Warm regards,<br />{business_name}</p> <p>&nbsp;</p>',
    ...
    'failed' => 'Failed',
    'sell' => 'Sell',
    'manage_your_backup' => 'Manage your Backups',
    'upload_light_logo' => 'Light Logo',
    'upload_dark_logo' => 'Dark Logo',
    'logo_help_light' => 'Replace light logo on sidebar',
    'logo_help_dark' => 'Replace Dark logo on sidebar',
    ...
    'transaction_business_name' => 'Transaction Business Name',
    'payment_business_name' => 'Payment Business Name',
    ...
    //3.0
    'invoice_total_labels' => 'Invoice Total Labels',
    'letter_head_help' => 'Upload a letterhead image containing all details of your business.
    Letterhead will be added at the top of the invoices. <br> Upload only if you want to replace previous letterhead',
    'primary_color' => 'Primary Color',
    'secondary_color' => 'Secondary Color',
    'reset_to_default' => 'Reset to Default',
    'disable_fy_sales_chart' => 'Disable F. Year Sales Chart',
    'notifaction' => 'Notification',
    'purchase_sell_mismatch' => 'Purchase Sell Mismatch',
    'remap_purchase_sell' => 'Rebuild Mapping for Purchase Sell',
    'remap_completed' => 'Remap Purchase Sell completed for location: :location, product: :product, variation: :variation',
    'purchase_sell_data_validation' => 'Please provide required Data business_id, location_id and variation_id',
    'purchase_sell_no_transaction_found' => 'No finalized sells found for the specified product. Nothing to remap.',
    'rebuild_mapping' => 'Rebuild Mapping',
    'do_not_close_window' => 'Please do not close the window. This process might take a few moments.',
    'processing' => 'Processing',
    'disable_sell_return_widget'     => 'Disable Sell Return Widget',
    'disable_purchase_return_widget' => 'Disable Purchase Return Widget',
    'disable_expense_widget'         => 'Disable Expense Widget',
    'disable_total_purchase_widget'  => 'Disable Total Purchase Widget',
    'disable_purchase_due_widget' => 'Disable Purchase Due Widget',
    //3.1
    'transfered_stock' => 'Transfered Stock',
    'customer_display_screen' => 'Customer Display Screen',
    'display_screen_heading' => 'Display screen heading',
    'image_help' => 'Previous Image (if exists) will be replaced<br> Recommended size 520x770 or 2:3 Aspect Ratio',
