...
return [
    ...
    */
    ...
    'langs' => [
        ...
        'sw' => ['full_name' => 'Kiswahili', 'short_name' => 'Swahili']
    ],
    ...
    'show_payments_recovered_today' => true,

    'enable_sell_in_diff_currency' => false,
    'currency_exchange_rate' => 1,
    'orders_refresh_interval' => 45, //Auto refresh interval on Kitchen and Orders page in seconds,
    ...
    'enable_download_pdf' => true,         //Experimental feature
    ...
    //'enable_custom_sidebar_logo' => env('ENABLE_CUSTOM_SIDEBAR_LOGO', false),
    
     /*
    |--------------------------------------------------------------------------
    | Media Upload Configuration
    |--------------------------------------------------------------------------
    | Configuration for allowed file types and MIME types for media uploads.
    */

    'media_upload' => [
        'allowed_extensions' => [
            'jpg', 'jpeg', 'png', 'pdf', 'doc', 'docx',
            'xls', 'xlsx', 'ppt', 'pptx', 'gif', 'svg', 'zip', 'csv'
        ],
        'allowed_mime_types' => [
            'image/jpeg',
            'image/png',
