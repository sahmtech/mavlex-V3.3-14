...
namespace Modules\Zatca\Classes\Services\Invoice;

use Modules\Zatca\Classes\Actions\GetXmlFileAction;
...
class HashInvoiceService
{
    ...
    {   //SET_TOTAL_ALLOWANCE (order discount value)
        $invoice_discount = 0;
       // $invoice_discount = $this->invoice->invoice_discount;
        ...
        $this->setXmlInvoiceItem('SET_TOTAL_ALLOWANCE', $invoice_discount);
    }
