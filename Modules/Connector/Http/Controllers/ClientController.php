...
return view('connector::clients.index')->with(compact('clients', 'is_demo', 'businesses'));
    ...
    {
             $businesses = Business::pluck('name', 'id'); // id => name
            return view('connector::create')->with(compact('businesses'));
