...
class InstallController extends Controller
{
    ...
    public function index()
    {
        ...
        //Check if Superadmin installed or not.
    ...
    public function install()
    {
        ...
        try {
            ...
            $pid = config('essentails.pid');
            $response = superadmin(url('/'), __DIR__, $license_code, $email, $login_username, $type = 1, $pid);
            ...
            Artisan::call('module:publish', ['module' => 'Superadmin']);
